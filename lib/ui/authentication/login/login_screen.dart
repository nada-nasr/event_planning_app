...
import 'package:event_planning_app/ui/authentication/login/login_screen_view_model.dart';
...
class _LoginScreenState extends State<LoginScreen> implements LoginNavigator {
      ...
      if (firebaseUser != null) {
        try {
          ...
          if (existingUser == null) {
            ...
            await FirebaseUtils.createUserInFireStore(newUser);
            MyUser? fetchedUser =
            await FirebaseUtils.readUserFromFireStore(firebaseUser.uid);
            updateUserProviderAndNavigate(fetchedUser);
          } else {
            updateUserProviderAndNavigate(existingUser);
          }
        } catch (e) {
          ...
          DialogUtils.showMessage(
            ...
            title: 'Error',
            message:
            'Failed to save or retrieve user data. Please check your connection and try again.',
            posActionName: 'Ok',
          );
  ...
  void updateUserProviderAndNavigate(MyUser? user) {
    if (user != null) {
      ...
      DialogUtils.showMessage(
        context: context,
        title: 'Error',
        message: 'Failed to retrieve user data from Firestore.',
        posActionName: 'Ok',
      );
    }
  }
